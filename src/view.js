...
=======
=======
>>>>>>> 25a261cceb5881c94ddc56b84bfc18d8d51a46c1
WIDTH = 500;
HEIGHT = 500;
...
/*
	...
	for (var nn = 0; nn < dimensions.length; nn++) {
		...
		y[0] += (dimensions[nn].previous[0] - 2 * me[0] + dimensions[nn].next[0]) / dimensions.length;
	}

	for (var ss = 101; ss < (1.0 / dt); ss++) {
		var k = waerme(y);
